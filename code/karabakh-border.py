...
def main():
  try:
    ...
    print "Defining input and output macro names"
    # Input
    ...
    border_raster_object.save(border_raster)
...
# arcpy.CopyRaster_management(red, karabakh_red, "", "", "256", "NONE", "NONE", "", "NONE", "NONE", "GRID", "NONE")
